...
for (const [id, title, image, columns, rows, column, row] of cards) {
  ...
  <svg x="14" y="14" width="572" height="722" viewBox="${column * 600} ${row * 750} 600 750" preserveAspectRatio="xMidYMid slice"><image href="${image}" width="${columns * 600}" height="${rows * 750}"/></svg>
